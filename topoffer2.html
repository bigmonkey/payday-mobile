    ...
    <body>
        ...
        <div data-role="page" id="page1">
            ...
            <div data-role="content">
              <form id="fullForm" method="get" action="http://www.thepaydayhound.com" data-ajax="false">
                <div data-role="fieldcontain">
                    <fieldset data-role="controlgroup" data-mini="true">
                        <input name="requested_loan_amount" id="requested_loan_amount" value="<?php echo $_POST["requested_loan_amount"]; ?>" type="" />
                        <input name="zip" id="zip"  value="<?php echo $_POST["zip"]; ?>" type="" />
                        <input name="email" id="email" value="<?php echo $_POST["email"]; ?>" type="" />
                        <input name="birth_date" id="birth_date" value="<?php echo $_POST["birth_date"]; ?>" type="" />
                        <input name="active_military" id="active_military" value="<?php echo $_POST["active_military"]; ?>" type="" />
                    </fieldset>
                </div>
                <div data-role="fieldcontain">
                    <fieldset data-role="controlgroup" data-mini="true">
