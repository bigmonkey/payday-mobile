...
function showCalendar(a){
    ...
    $(a).mobiscroll().date({
        ...
        mode: 'scroller',
        dateOrder: 'mmD ddyy',
        minDate: new Date(actualDate.getFullYear(),actualDate.getMonth(),actualDate.getDate()), 
        maxDate: new Date(futureDate.getFullYear(),futureDate.getMonth(),futureDate.getDate()),
    });    
